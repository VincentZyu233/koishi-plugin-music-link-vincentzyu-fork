...
const Config = Schema.intersect([
    ...
    Schema.union([
        ...
        Schema.object({
            ...
            command6_searchList: Schema.number().default(50).min(1).max(100).description('歌曲搜索的列表长度。返回的候选项个数。不建议超过50，可能超过最长文本长度/让图片渲染、发送、加载时间变长'),
        ...
        Schema.object({
            ...
            command8_searchList: Schema.number().default(50).min(1).max(100).description('歌曲搜索的列表长度。返回的候选项个数。不建议超过50，可能超过最长文本长度/让图片渲染、发送、加载时间变长'),
